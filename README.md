...
| `/야차 상대:@멤버 수위:순한맛|매운맛|불맛|지옥맛 횟수:1~3 상세:True` | 연령제한 채널 전용. 태그 풀 = booru-v5(단보루 성인 태그 ~900개·한글 번역, 24h 캐시 `data/booru/`, 실패 시 내장 풀). 대결→승자가 그려옴. 불맛↑ 공통/🔝탑(여성형 의상·신체 제외)/🔻바텀. `상세`=태그 뜻+연관 세부 태그. 페티시·미성년·수간·고어·배설 제외 |
| `/폭력 상대:@멤버 횟수:1~3 상세:True` | 연령제한 채널 전용. 폭력이다! 폭력! — 유혈(폭력성 분류)+비동의·강압 태그 전용 ||매운맛|불맛|지옥맛 횟수:1~3` | 연령제한 채널 전용. 상대 있으면 1d100 대결→승자가 그려옴(무승부 둘 다). 불맛↑은 2인 구도+체위+체액·토이, 공통/🔝탑/🔻바텀 3줄 분리 ||순한맛 횟수:1~3` | 연령제한 채널 전용. NSFW 태그 랜덤 조합(한글+단보루), 음흉 양키 대사 |
